...
import br.com.danielfreitassc.cursoSpringBoot.mapper.custom.PersonMapper;
...
public class PersonServices {
    ...
    public PersonDTOV2 createV2(PersonDTOV2 person){
        ...
        logger.info("Criando uma pessoa com a versão V2!");  
        var entity = mapper.converDtoToEntity(person);
